...
def _parse_arguments(desc, args):
    ...
    parser.add_argument('--clixocmd', default='/clixo/clixo',
                        help='Full path to CliXO command')
...
def run_clixo(clixocmd, graph, alpha=0.1, beta=0.5):
    ...
    cmdargs = [clixocmd, '-i', graph, '-a', str(alpha),
               '-b', str(beta)]
...
def main(args):
    ...
    try:
        ...
        return run_clixo(theargs.clixocmd, inputfile, alpha=theargs.alpha,
                         beta=theargs.beta)
